            ...
            <tr>
              <th style={{ padding: "0px"}}>
                <div className='editEliminardiv'>
                  <svg xmlns="http://www.w3.org/2000/svg" onClick={goBack} style={{ cursor: 'pointer' }} width="30" height="30" viewBox="0 0 210 214" fill="none">
                    ...
                    <Link className='plus' to={'/Forms/Register'}><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                  ...
                  <svg style={{ cursor: 'pointer' }} onClick={EditarUsuario.bind(null, selectedUserId)} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                  ...
                  <img src="/img/borrar.png" alt="basura" onClick={Alerta.bind(null, selectedUserId)} width="30" height="35" style={{cursor:'pointer'}} />
